...
#                 aug_params = {}
                ...
                for i, aug in enumerate(augmentations):
                    ...
                    if aug == 'mixup':
                        transform_args['training_matrices'] = train_features
...
pred_results.to_csv(f"results/pred_results.csv", index=False)
...
if AUGMENTATION is None:
    ...
    AUGMENTATION = f'_{AUGMENTATION}'
prediction_metrics.to_csv(f"results/prediction_metrics{AUGMENTATION}.csv", index=False)
